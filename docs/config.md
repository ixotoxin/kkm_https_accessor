...
| `log.eventLog.level.foreground` | Enum: "info", "warning", "error", "none"                                             | Уровень логирования в журнал событий Windows для foreground-процесса.                                                 |
| `log.eventLog.level.background` | Enum: "info", "warning", "error", "none"                                             | Уровень логирования в журнал событий Windows для background-процесса.                                                 |
