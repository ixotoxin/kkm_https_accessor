...
namespace Server::KkmOp::Wcs {
    ...
    constexpr Csv c_notFound { L"ККМ [{}] не доступна" };
    constexpr Csv c_cantClearRegistry { L"Не удалось очистить реестр параметров подключения" };
}
