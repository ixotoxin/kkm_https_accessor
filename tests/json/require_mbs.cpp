...
namespace UnitTests::Mbs {
    TEST_CASE("Obtain a reference to an array within the MBS JSON object", "[json][mbs]") {
    ...
    TEST_CASE("Obtain a reference to an object within the MBS JSON object", "[json][mbs]") {
        Json::Allocator allocator {};
        Json::Mbs::Document jsonDoc { &allocator };
