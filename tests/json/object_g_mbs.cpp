...
namespace UnitTests::Mbs {
    TEST_CASE("Handle MBS JSON object with callback", "[json][mbs]") {
        using Json::Mbs::Value;
        ...
        REQUIRE_FALSE(ison[nullKey]([] (const Json::Mbs::Value &, const Json::PtrView) { return true; }));
        REQUIRE(ison[emptyObjectKey].handle([] (const Json::Mbs::Value &, const Json::PtrView) { return true; }));
        REQUIRE(ison[emptyArrayKey]([] (const Json::Mbs::Value &, const Json::PtrView) { return true; }));

        {
            SizeType testValue {};
            REQUIRE(
                ison[arrayKey](
                    [& testValue] (const Json::Mbs::Value & v, const Json::PtrView)
        ...
        REQUIRE(ison[trueKey]([] (const Json::Mbs::Value & v, const Json::PtrView) { return v.GetBool(); }));
        REQUIRE_FALSE(ison[falseKey]([] (const Json::Mbs::Value & v, const Json::PtrView) { return v.GetBool(); }));

        REQUIRE_THROWS_AS(
            ison[zeroNumKey].handle(
                [] (const Json::Mbs::Value &, const Json::PtrView) -> bool {
        ...
        REQUIRE(
            ison[strKey].handle(
                [] (const Json::Mbs::Value & v, const Json::PtrView) {
                    REQUIRE(v.IsString());
        ...
        REQUIRE(
            ison[subKey](
                [] (const Json::Mbs::Value & v, const Json::PtrView) {
                    return Json::handle(v, [] (const Json::Mbs::Value & v2, const Json::PtrView) {
                        REQUIRE(v2.IsObject());
    ...
    TEST_CASE("Get value by key from MBS JSON object", "[json][mbs]") {
        ...
        {
            std::string testValue { false };
            REQUIRE_NOTHROW(ison[trueKey].get(testValue));
            REQUIRE(testValue == Text::yesNo<Meta::Mbs>(trueVal));
            REQUIRE_NOTHROW(ison[falseKey] >>= testValue);
            REQUIRE(testValue == Text::yesNo<Meta::Mbs>(falseVal));
    ...
    TEST_CASE("Get value by key from MBS JSON object within domain", "[json][mbs]") {
        using Basic::RefPair;
    ...
    TEST_CASE("Get value by key from MBS JSON object with cast map", "[json][mbs]") {
        using Basic::RefPair;
