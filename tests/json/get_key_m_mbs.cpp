...
namespace UnitTests::Mbs {
    TEST_CASE("Getting MBS JSON object property with cast map #1", "[json][mbs]") {
    ...
    TEST_CASE("Getting MBS JSON object property with cast map #2", "[json][mbs]") {
        Json::Allocator allocator {};
        Json::Mbs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Getting MBS JSON object property with cast map #3", "[json][mbs]") {
        Json::Allocator allocator {};
        Json::Mbs::Document jsonDoc { &allocator };
