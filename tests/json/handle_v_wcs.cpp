...
namespace UnitTests::Wcs {
    TEST_CASE("Handle WCS JSON value or object property #1", "[json][wcs]") {
    ...
    TEST_CASE("Handle WCS JSON value or object property #2", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #3", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #4", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #5", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #6", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #7", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #8", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON value or object property #9", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
        ...
        {
            std::wstring output { strCheckVal };
            REQUIRE(Json::handle(jsonDoc[kv(strKey)], output, Text::Wcs::maxLength(strVal.size() + 1)));
            REQUIRE(output == strVal);
        }

        {
            std::wstring output { strCheckVal };
            REQUIRE_THROWS_AS(
                std::ignore = Json::handle(jsonDoc[kv(strKey)], output, Text::Wcs::maxLength(strVal.size() - 1)),
                Basic::DataError
            );
            REQUIRE(output == strCheckVal);
        }
        ...
        {
            std::wstring output { strCheckVal };
            REQUIRE(Json::handle(jsonDoc[kv(strKey)], output, Text::Wcs::lower()));
        ...
        {
            std::wstring output { strCheckVal };
            REQUIRE(Json::handleKey(jsonDoc, strKey, output, Text::Wcs::maxLength(strVal.size() + 1)));
            REQUIRE(output == strVal);
        }

        {
            std::wstring output { strCheckVal };
            REQUIRE_THROWS_AS(
                std::ignore = Json::handleKey(jsonDoc, strKey, output, Text::Wcs::maxLength(strVal.size() - 1)),
                Basic::DataError
            );
            REQUIRE(output == strCheckVal);
        }
        ...
        {
            std::wstring output { strCheckVal };
            REQUIRE(Json::handleKey(jsonDoc, strKey, output, Text::Wcs::lower()));
            REQUIRE_FALSE(output == strVal);
            REQUIRE(output == Text::lowered(strVal));
        }
    }
