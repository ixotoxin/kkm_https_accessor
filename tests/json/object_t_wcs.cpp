...
namespace UnitTests::Wcs {
    TEST_CASE("Handle WCS JSON object wrapper's predicates #1", "[json][wcs]") {
    ...
    TEST_CASE("Handle WCS JSON object wrapper's predicates #2", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON object wrapper's predicates #3", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Handle WCS JSON object wrapper's predicates #4", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document jsonDoc { &allocator };
