...
namespace UnitTests::Mbs {
    TEST_CASE("Getting MBS JSON object property within domain #1", "[json][mbs]") {
    ...
    TEST_CASE("Getting MBS JSON object property within domain #2", "[json][mbs]") {
        Json::Allocator allocator {};
        Json::Mbs::Document jsonDoc { &allocator };
    ...
    TEST_CASE("Getting MBS JSON object property within domain #3", "[json][mbs]") {
        Json::Allocator allocator {};
        Json::Mbs::Document jsonDoc { &allocator };
