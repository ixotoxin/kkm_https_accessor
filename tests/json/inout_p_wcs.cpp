...
namespace UnitTests::Wcs {
    TEST_CASE("Unserialize/serialize WCS JSON object from/to file", "[json][wcs]") {
        using Catch::Matchers::WithinRel;

        Json::Allocator allocator {};
        Json::Wcs::Document originalJsonDoc { &allocator };
        Json::Wcs::Document loadedJsonDoc { &allocator };
    ...
    TEST_CASE("Check encoding of content written to file (WCS JSON object)", "[json][wcs]") {
        Json::Allocator allocator {};
        Json::Wcs::Document originalJsonDoc { Json::Type::Object, &allocator };
        Json::Wcs::Document loadedJsonDoc { &allocator };
        std::filesystem::path jsonFile { tempFile() };

        originalJsonDoc.AddMember(encodingTestKey, Json::Wcs::Value { encodingTestVal.c_str(), allocator }, allocator);
