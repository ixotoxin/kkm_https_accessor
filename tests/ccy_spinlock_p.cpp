...
namespace UnitTests {
    namespace Test1 {
        TEST_CASE("Ccy::SpinLock<Ccy::SpinMethod::Pause> try_lock/unlock", "[operating]") {
            Ccy::SpinLock<Ccy::SpinMethod::Pause> spinLock;
    ...
    namespace Test2 {
        TEST_CASE("Ccy::SpinLock<Ccy::SpinMethod::Pause> with std::scoped_lock", "[operating]") {
            Ccy::SpinLock<Ccy::SpinMethod::Pause> spinLock;
            REQUIRE(spinLock.try_lock());
            spinLock.unlock();
            {
    ...
    namespace Test5 {
        TEST_CASE("Concurrency workloads using a Ccy::SpinLock<Ccy::SpinMethod::Pause>", "[concurrency]") {
