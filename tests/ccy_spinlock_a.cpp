...
namespace UnitTests {
    namespace Test1 {
        TEST_CASE("Ccy::SpinLock<Ccy::SpinMethod::Active try_lock/unlock", "[operating]") {
            Ccy::SpinLock<Ccy::SpinMethod::Active> spinLock;
    ...
    namespace Test2 {
        TEST_CASE("Ccy::SpinLock<Ccy::SpinMethod::Active with std::scoped_lock", "[operating]") {
            Ccy::SpinLock<Ccy::SpinMethod::Active> spinLock;
            REQUIRE(spinLock.try_lock());
            spinLock.unlock();
            {
    ...
    namespace Test5 {
        TEST_CASE("Concurrency workloads using a Ccy::SpinLock<Ccy::SpinMethod::Active>", "[concurrency]") {
