...
SET GENERATE_OPTS=-D CMAKE_CXX_COMPILER=%CLANG_CXX_FRONTEND% -D CMAKE_BUILD_TYPE=Debug %COMMON_OPTS% -D WITH_CRTD=ON -D WITH_LEAKS=%LEAKS%
SET BUILD_OPTS=--config Debug --verbose
SET BUILD_DIR=../__temp/crtd-clang
